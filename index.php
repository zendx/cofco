...
<html lang="en">
<?php 
    $wsi = plugin_dir_url(__FILE__) . "assets/"; 
    $wsi_path = plugin_dir_path(__FILE__) . "assets/";
?>
<head>
    <!-- Required meta tags  -->
    <meta charset="utf-8">
    ...
    <script defer src="<?php echo $wsi; ?>js/app435e.js?1096aad991449c8654b2"></script>
    <link href="<?php echo $wsi; ?>css/app435e.css?1096aad991449c8654b2" rel="stylesheet">
</head>
...
<body class="main-bg main-bg-opac main-bg-blur adminuiux-sidebar-fill-white adminuiux-sidebar-boxed theme-blue roundedui" 
    ...
    <!-- Pageloader -->
    <?php include_once $wsi_path . "inc/header.php"; ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="text-secondary">
                                                    Total Assets 
                                                    <span class="text-success fs-14">
                                                        <i class="bi bi-arrow-up"></i> 25.35%
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="text-secondary">
                                                    Net Margin 
                                                    <span class="text-success fs-14">
                                                        <i class="bi bi-arrow-up"></i> 56.51%
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <div class="card adminuiux-card bg-theme-1-subtle">
                                            <div class="card-body z-index-1">
                                                <h4 class="fw-medium">$5560.50</h4>
                                                <p class="text-secondary">Expense 
                                                    <span class="text-success fs-14">
                                                        <i class="bi bi-arrow-up"></i> 11.5%
                                                    </span>
                                                </p>
                        ...
                        <div class="card adminuiux-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-auto">
                                        <button class="btn btn-square btn-theme mt-2">
    ...
    <!-- footer -->
    <?php include_once $wsi_path . "inc/footer.php"; ?>

    <!-- Page level JS -->
    <script src="<?php echo $wsi; ?>js/investment/investment-dashboard.js"></script>
